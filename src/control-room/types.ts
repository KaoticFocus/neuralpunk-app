...
export interface ProtocolEvent { id:string; protocol:'MCP'|'A2A'|'HTTP'|'SYSTEM'; actorId:string; action:string; authorization:'ALLOWED'|'DENIED'; status:number; createdAt:string; }
